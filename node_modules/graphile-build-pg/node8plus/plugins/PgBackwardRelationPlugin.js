...
exports.default = function PgBackwardRelationPlugin(builder, { pgLegacyRelations, pgSimpleCollections }) {
  ...
  builder.hook("GraphQLObjectType:fields", (fields, build, context) => {
    ...
    return extend(fields, foreignKeyConstraints.reduce((memo, constraint) => {
      ...
      const isUnique = !!introspectionResultsByKind.constraint.find(c => c.classId === table.id && (c.type === "p" || c.type === "u") && c.keyAttributeNums.length === keys.length && c.keyAttributeNums.every((n, i) => keys[i].num === n));
