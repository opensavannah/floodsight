...
exports.default = async function viaTemporaryTable(pgClient, sqlTypeIdentifier, sqlMutationQuery, sqlResultSourceAlias, sqlResultQuery, isPgClassLike = true) {
  ...
  if (!sqlTypeIdentifier) {
    ...
    const selectionField = isPgClassLike ? /*
                                            ...
                                            */
    sql.query`(case when ${sqlResultSourceAlias} is null then null else ${sqlResultSourceAlias} end)` : sql.query`(${sqlResultSourceAlias}.${sqlResultSourceAlias})::${sqlTypeIdentifier}`;
    ...
    const convertFieldBack = isPgClassLike ? sql.query`(str::${sqlTypeIdentifier}).*` : sql.query`str::${sqlTypeIdentifier} as ${sqlResultSourceAlias}`;
